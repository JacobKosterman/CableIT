...
@Database(entities = {Company.class, Address.class, Product.class, ProductCategory.class, Contact.class, Quote.class, QuoteLine.class, Phone.class}, version = 18, exportSchema = false)
